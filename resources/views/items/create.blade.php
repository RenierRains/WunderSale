...
<div class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="w-full max-w-xl mx-auto p-8 bg-white shadow-md rounded-lg">
        <h1 class="text-2xl font-semibold text-gray-800 mb-6 text-center">List a New Item</h1>
        ...
        <form action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="3" class="form-textarea mt-1 block w-full border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md"></textarea>
            </div>
